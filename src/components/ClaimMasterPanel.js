...
class ClaimMasterPanel extends FormPanel {
  ...
  constructor(props) {
    ...
    this.allowGuarantee = props.modulesManager.getConf(
      "fe-claim",
      "claimForm.guarantee"
    );
      ...
      <Grid container>
        ...
        <ControlledField
          ...
          field={
            <Grid item xs={2} className={classes.item}>
              <PublishedComponent
                pubRef="claim.PrescriberTypePicker"
                value={edited.prescriberType}
                reset={reset}
                onChange={(v, s) => this.updateAttribute("prescriberType", v)}
                readOnly={ro}
                required
              />
            </Grid>
        ...
        {!forFeedback && (
          <Fragment>
            ...
            />
            {!!this.allowDiagnosis2 && <ControlledField
              module="claim"
        ...
        {!!this.allowGuarantee && <ControlledField
          module="claim"
          id="Claim.guarantee"
          field={

...
class PreauthorizationEditPage extends Component {
  constructor(props) {
    super(props);
...
export default withHistory(
  withModulesManager(connect(mapStateToProps, mapDispatchToProps)(injectIntl(withTheme(withStyles(styles)(PreauthorizationEditPage))))),
);
